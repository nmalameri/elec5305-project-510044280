...
Purpose:
    To generate plots and per-attack EER tables for GMM experiments.

Functionality:
    - Loading ROC files and score CSVs generated by Step 05 (05_gmm.py)
    - Ploting ROC curves
    - Calculating EER per attack ID (A07–A19)
    - Exporting tables (CSV, LaTeX) for the report

Inputs:
    results/models/gmm_*/<run_tag>/
...
Notes:
    This script is for visualisation and report-ready tables.
"""
